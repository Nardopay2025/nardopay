-- Recreate views with SECURITY INVOKER to fix linter errors
...
-- Create secure views with SECURITY INVOKER (queries run with permissions of the user, not view creator)
