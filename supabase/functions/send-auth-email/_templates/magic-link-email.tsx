...
export const MagicLinkEmail = ({
  ...
  <Html>
    <Head />
    <Preview>Your magic link to sign in to NardoPay - Quick and secure access</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            Click the button below to securely sign in to your NardoPay account. No password needed!
          </Text>
          ...
          <Section style={codeSection}>
            <Text style={codeLabel}>Or use this one-time code:</Text>
            <Text style={code}>{token}</Text>
            <Text style={codeHelp}>Enter this code if the button above doesn't work</Text>
          </Section>
