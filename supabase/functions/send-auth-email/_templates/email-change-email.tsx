...
export const EmailChangeEmail = ({
  ...
  <Html>
    <Head />
    <Preview>Confirm your email change on NardoPay - Verify your new email</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            We received a request to change the email address associated with your NardoPay account. To complete this change, please verify your new email address:
          </Text>
          ...
          <Section style={warningSection}>
            ...
            <Text style={warningText}>
              If you didn't request this email change, please <strong>do not click the button above</strong> and contact our support team immediately. This may indicate unauthorized access to your account.
            </Text>
            <Text style={warningText}>
