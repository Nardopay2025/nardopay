        ...
        try {
          await supabase.functions.invoke('send-payment-emails', {
            body: {
              ...
              message: 'We noticed you tried to create a subscription link. Our service is currently available in Zimbabwe. We\'ll notify you via email when it becomes available in your country.',
            },
          });
        } catch (emailError) {
